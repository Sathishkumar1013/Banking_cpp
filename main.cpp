...
class Menu{
    ...
    void subMenuATM() {  // Added new submenu for ATM
        cout<<"1. Withdraw"<<endl;
        cout<<"2. Check Balance"<<endl;
        cout<<"3. Load Money"<<endl;
        cout<<"4. Exit"<<endl;
    }
};
class Bank{
...
int main(){
    ...
    while(choice!=3){
        ...
        if(choice==2){
            m1.subMenuATM();  // Show ATM menu
            int atmChoice;
            cin >> atmChoice;
            
            while(atmChoice != 4) {
                if(atmChoice == 1) {  // Withdraw
                    main3:
                    cout<<"Enter Account Number = ";
                    int accNumber;
                    cin>>accNumber;
                ...
                else if(atmChoice == 2) {  // Check Balance
                    cout<<"Enter Account Number = ";
                    int accNumber;
                    cin>>accNumber;
                    cout<<"Enter pin = ";
                    ...
                    cin>>pass;
                    if (lc1.loginCheck(accNumber,pass)==true){
                        int balance = atm1.getBalance(accNumber);
                        if(balance != -1) {
                        ...
                        cout<<"\n\nIncorrect credentials"<<endl<<endl;
                    }
                }
                else if(atmChoice == 3) {  // Load Money
                    cout<<"Enter Account Number = ";
                    int accNumber;
                    cin>>accNumber;
                    cout<<"Enter pin = ";
